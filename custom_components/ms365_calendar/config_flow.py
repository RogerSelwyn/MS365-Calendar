...
class MS365CalendarConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    """Example config flow."""
    ...
    def async_get_options_flow(config_entry):
        ...
        return MS365CalendarOptionsFlowHandler(config_entry)
    ...
    async def async_step_user(self, user_input=None):
        ...
        data = self._config_schema or CONFIG_SCHEMA
...
class MS365CalendarOptionsFlowHandler(config_entries.OptionsFlow):
